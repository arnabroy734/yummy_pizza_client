...
export default function OrderSummary({ orderId, orderDate, orderTime, totalItems, orderStatus, orderItems, address, phone, orderPrice }) {

    let [showOrderDetail, setOrderDetailVisibility] = useState(false);
        ...
        <li className="order-card mx-4 bg-white w-full md:w-fit my-8 shadow-lg">
            ...
            <div className="details flex py-4 pr-4">
                ...
                <div className="flex flex-col justify-between">
                    ...
                    <h1 className="text-color2 underline underline-offset-2 font-bold cursor-pointer"
            ...
            {showOrderDetail? <OrderDetailPreview
                orderId = {orderId}
                showPreview = {setOrderDetailVisibility}
